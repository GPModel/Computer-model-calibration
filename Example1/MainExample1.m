...
ylabel('Average  $S_h(\hat{\textbf{x}}^*_{\mathbf{ML}})-1029$','Interpreter','latex','FontSize',32);
...
FontSize77=19;
text(1,1.025*medians(1),['Median=' num2str(medians(1),2)],'HorizontalAlignment','center','FontSize',FontSize77,'FontWeight','Bold')
text(2,1.035*medians(2),['Median=' num2str(medians(2),2)],'HorizontalAlignment','center','FontSize',FontSize77,'FontWeight','Bold')
