...
elseif Case==3
    Y=Simulator3(x,Level);    
end
end
%%
function [Output,Temperature]=Simulator1(xx,Level)
...
if Level==1 
    thermalBC(thermalmodel,'Edge',[RE LE TopE],'ConvectionCoefficient',ConvectionCoefficient,'AmbientTemperature',1000);%celsius
    thermalBC(thermalmodel,'Edge',BottomE,'Temperature',100);
elseif Level==2
    thermalBC(thermalmodel,'Edge',[RE LE TopE],'ConvectionCoefficient',ConvectionCoefficient,'AmbientTemperature',1000,'Emissivity',0.05);%celsius
    thermalBC(thermalmodel,'Edge',BottomE,'Temperature',100);
...
%%
function [Y,YRow]=Simulator3(xx,Level)
% OUTPUT AND INPUTS:
