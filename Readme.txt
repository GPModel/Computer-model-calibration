...
NOTE: The address of the folder containing all the Matlab codes, the EPBasicFile.idf file, and the EPWeather.epw file 
      cannot contain any space ' ' (e.g., the address <C:\Users\YWX\Desktop\MatlabCodes_ModifiedSl> for the folder is allowed 
      but not <C:\Users\YWX\Desktop\Matlab Codes ModifiedSl>).
...
CalibrationSRGP_LR.m----------Implements the single fidelity SR-GP or LR method.
