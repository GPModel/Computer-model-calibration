...
Example1Size2.mat ----------Saved simulations data for Example 1, larger design size.
Example2.mat----------Saved simulations data for Example 2.
Example2Size2.mat----------Saved simulations data for Example 2, larger design size.
Example3.mat----------Saved simulations data for Example 3.
Example3Size2.mat----------Saved simulations data for Example 3, smaller design size.