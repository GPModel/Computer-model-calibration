...
save Example3Design.mat
%%
load Example3Design.mat
...
for id=1:NoTrials
    ...
    save('Example3Results.mat', 'T_BC_AGP', 'T_BC_GP', 'T_MBC_AGP', 'T_MID_AGP', 'T_Nested', 'T_SR_AGP', 'T_SR_GP', 'T_SVD', 'T_SVDAGP','SSE_XMLE','XMLE','RatioCost','Budget','nl','nh','nh0','InitialBudget')
end
%%
%Section 3: Show BO results
clc,clear
load('Example3Results.mat');
idx=(1:100);
