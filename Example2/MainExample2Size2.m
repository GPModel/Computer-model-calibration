...
for id =1:NoTrials
    ...
    save Example2Size2Design.mat
end
%%
%Section 2: Bayesian optimization
load Example2Size2Design.mat
...
for id=1:NoTrials
    ...
    save('Example2Size2Results.mat', 'Data_BC_AGP', 'Data_BC_GP', 'Data_MBC_AGP', 'Data_MID_AGP', 'Data_Nested', 'Data_SR_AGP', 'Data_SR_GP', 'Data_SVD', 'Data_SVDAGP', 'T_BC_AGP', 'T_BC_GP', 'T_MBC_AGP', 'T_MID_AGP', 'T_Nested', 'T_SR_AGP', 'T_SR_GP', 'T_SVD', 'T_SVDAGP','RatioCost','Budget1','Budget','InitialBudget','nl','nh','nh0','PhysData')
end
%%
%Section 3: Show BO results
clear,clc
load Example2Size2Results.mat
idx=(1:100);
